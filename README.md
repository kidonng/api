...
Use your gists as counters, with customizable step and badge creation.

**NOTE**: Due to the nature of GitHub API, Gist Counter may not be performant compared to other solutions.
